# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-04-26 20:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('community', '0004_auto_20160419_2042'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_conditions', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=10), blank=True, null=True, size=None)),
                ('daily_activity_level', models.CharField(choices=[('low', 'Low'), ('high', 'High'), ('moderate', 'Moderate'), ('in bed', 'You spend the whole day in bed/No movements')], max_length=255)),
                ('exercise_freq', models.CharField(choices=[('random', 'Random'), ('15 min', '15 minutes'), ('30 min', '30 minutes'), ('1 hr or more', '1 hour/above 1 hour')], max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Person',
